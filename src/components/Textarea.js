    ...
    <>
      ...
      <div >
        <div className="container mt-3">
          ...
          <button className={`btn btn-${props.mode=== 'dark' ? 'warning': 'primary'} mx-2 my-1`} disabled={text.length===0} onClick={butnfunc}>
            Capitalize
          </button>
          <button className={`btn btn-${props.mode=== 'dark' ? 'warning': 'primary'} mx-2 my-1`} disabled={text.length===0}onClick={butnfuncmin}>
            Minimize
          </button>
          <button className={`btn btn-${props.mode=== 'dark' ? 'warning': 'primary'} mx-2 my-1`} disabled={text.length===0}onClick={butnfuncclear}>
            Clear text
          </button>
